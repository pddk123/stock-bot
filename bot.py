...
def main():
    ...
    # 1. 대상 종목 및 포트폴리오 준비 (zfill 6자리 정렬 복원)
    ...
    # 2. 병렬 분석 실행 (중복 충돌 방지를 위해 포트폴리오 우선 분리)
